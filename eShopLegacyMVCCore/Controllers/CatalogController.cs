...
namespace eShopLegacyMVC.Controllers
{
    public class CatalogController : Controller
    {
        ...
        private readonly MessageQueueSettings messageQueueSettings;

        public CatalogController(ICatalogService service, IOptions<MessageQueueSettings> options)
        {
            this.service = service;
            this.messageQueueSettings = options.Value;
        }
        ...
        {
            using (var queue = new MessageQueue(messageQueueSettings.NewItemQueuePath))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        // Exclude = "PictureUri,CatalogType,CatalogBrand"
