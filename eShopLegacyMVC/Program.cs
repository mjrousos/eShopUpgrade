...
namespace eShopLegacyMVC
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Normally this would be a simple app.UseStaticFiles() call (with fonts and
            // images moved under wwwroot), but in order to minimize the changes to the
            // original code, we're serving static files from subdirectories under
            // content root instead of wwwroot.
